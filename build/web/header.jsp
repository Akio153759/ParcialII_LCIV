<%-- 
    Document   : header
    Created on : 30 oct. 2021, 01:11:29
    Author     : Tama
--%>
...
<head>
    ...
    <title>Sistema integral de farmacia</title>
    ...
    <!-- dark datatable CSS
		============================================ -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/dark-datatable.css">
    <!-- buttons CSS
		============================================ -->
